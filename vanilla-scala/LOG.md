...
*Additional instruction**: Use the package `claude.skills`

**Correction**: Do not use mutable collections in Scala FP projects

### First task - no tests

Not a correction because the instructions did not say to write tests.

After asking for tests, five tests written, they seem reasonable.
